...
const Skills = () => {
  return (
    <div name='skills' className=' w-full h-full pt-[100px] bg-[#e5e2c4] text-[#575e73]'>
        {/* container */}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center text-center w-full h-full '>
            <div>
                <p className='text-4xl text-black font-bold inline border-b-4 border-[#548f6f]'>Indica</p>
            </div>
                {/* col aanpassen */}
