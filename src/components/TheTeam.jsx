...
const TheTeam = () => {
  return (
    <div name='' className='w-full h-full pt-16 pb-28 text-[#575e73] text-center bg-white' style={{backgroundImage: `url(${bg})`, backgroundSize: "cover"}}>
      <div className='mx-auto px-1 flex flex-col justify-center w-[80%] h-full'>
        <h2 className='font-bold pb-8 text-white' style={{ fontFamily: 'MilkyWay', fontSize: '8rem' }} >Our Team</h2>
        {/* Container */}
        <div className='grid grid-cols-1 md:grid-cols-3 gap-12'>
          ...
          <div className='relative group'>
            ...
            <div className='absolute bottom-0 w-full bg-white bg-opacity-90 py-2'>
              <h3 className='font-bold text-xl'>Isabelle Fontaine</h3>
          ...
          <div className='relative group'>
            ...
            {/* Name card */}
            <div className='absolute bottom-0 w-full bg-white bg-opacity-90 py-2'>
              <h3 className='font-bold text-xl'>Sophie Laurent</h3>
          ...
          <div className='relative group'>
            ...
            {/* Name card */}
            <div className='absolute bottom-0 w-full bg-white bg-opacity-90 py-2'>
              <h3 className='font-bold text-xl'>Elena Dufour</h3>
