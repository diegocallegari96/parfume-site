  ...
  return (
    <div name='' className='relative w-full h-screen'>
      ...
      <div className='relative z-10 flex justify-center items-center w-full h-full'>
        <div className='text-center px-4 md:px-10 lg:px-20 max-w-[900px]'>
          <h1 style={{ fontFamily: 'MilkyWay' }} className='text-white font-bold mb-8 text-4xl md:text-5xl'>
            The Craftsmanship
          </h1>
          ...
          <p className='text-base md:text-lg text-[#eaeaea] leading-relaxed mt-4'>
